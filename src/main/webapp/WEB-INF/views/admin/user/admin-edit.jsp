				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						<div class="row">
                                <div class="row">
                                        <div class="col-xs-12">
                                            <form class="form-horizontal" role="form" id="formEditAdmin" >
                                               <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                        <label class="col-sm-3 control-label no-padding-right" > Chọn Quyền </label>
                                                            <div class="col-sm-9">
                                                                    <label class="checkbox-inline"><input type="radio" value="1" id="listroles"  name="listroles" disabled checked >Quản Trị Viên</label>
                                                                    <label class="checkbox-inline"><input type="radio" value="2" id="listroles"  name="listroles"  disabled >Nhân Viên</label>
                                                            </div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
                                                    <label class="col-sm-3 control-label no-padding-right"></label>
                                                        <div class="col-sm-9">
																<button type="button" class="btn btn-primary" id="btnEditAdmin" >Cập Nhập Tài Khoản</button>
