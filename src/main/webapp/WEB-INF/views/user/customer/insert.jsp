                                ...
                                <div class="row">
                                        <div class="col-xs-12">
                                            <form class="form-horizontal" role="form" id="formEdit" >
												...
												<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="district"> Tòa Nhà Thuê </label>
														<div class="col-sm-9">
														   <select id="district" name="buildingId" class="form-control">
                                                ...
                                                <input type="hidden" value="${SecurityUtils.getPrincipal().getId()}" id="staffId" name="staffId"/>
												<div class="form-group">
                                                    <label class="col-sm-3 control-label no-padding-right"></label>
                                                        <div class="col-sm-9">
																<button type="button" class="btn btn-primary" id="btnAddCustomerStaff" >Thêm Tài Khoản</button>
