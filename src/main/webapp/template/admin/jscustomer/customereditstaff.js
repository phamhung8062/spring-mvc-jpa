$('#btnAddCustomerStaff').click(function() {
	var data = {};
	...
	$.ajax({
		...
		success : function (response) {
			...
			window.location="http://localhost:8080/user/customer/list?page=1&limit=10&staffId="+id+"";
			//console.log('success');
		},
		error : function(response) {
			alert('Thêm Không Thành Công');
			window.location="http://localhost:8080/user/customer/list?page=1&limit=10";
		}
	});
})
